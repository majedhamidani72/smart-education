...
class SettingService
{
    ...
    */
    ...
    /**
     * متن یک پیامک را از تنظیمات می‌خواند و جای‌گزین‌های {کلید}
     * را با مقدار واقعی پر می‌کند.
     */
    public function smsText(string $key, array $replacements = []): string
    {
        $text = (string) $this->getValue($key, '');
