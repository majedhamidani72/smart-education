    ...
    @push('scripts')
        <script>
            document.addEventListener('alpine:init', () => {
                ...
                |--------------------------------------------------------------------------
                */
                // نکته‌ی مهم: این تقسیم باید به‌سمت صفر ناقص شود
                // (truncate)، نه به‌سمت پایین (floor) — برای اعداد
                // منفی این دو فرق دارند و الگوریتم تبدیل تاریخ
                // دقیقاً به رفتار truncate نیاز دارد. استفاده‌ی
                // اشتباه از Math.floor باعث می‌شد ماه‌های نزدیک به
                // مرز سال (فروردین) اشتباه محاسبه شوند.
