    ...
    @elseif ($viewLevel === 'examLevels')
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));gap:1rem">
            ...
            <button wire:click="selectExamLevel('section')"
                style="position:relative;text-align:right;cursor:pointer;background:rgba(20,184,166,0.06);border:1px solid rgba(20,184,166,0.3);border-right:4px solid rgb(20,184,166);border-radius:1rem;padding:1.25rem">
                @if ($isReviewer && $counts['pending_section'] > 0)
                    <span style="position:absolute;top:-.5rem;left:-.5rem;background:rgb(220,38,38);color:#fff;font-size:.7rem;font-weight:700;border-radius:999px;padding:.15rem .5rem">
                        {{ $counts['pending_section'] }} در انتظار
                    </span>
                @endif
            ...
            <button wire:click="selectExamLevel('chapter')"
                style="position:relative;text-align:right;cursor:pointer;background:rgba(99,102,241,0.06);border:1px solid rgba(99,102,241,0.3);border-right:4px solid rgb(99,102,241);border-radius:1rem;padding:1.25rem">
                @if ($isReviewer && $counts['pending_chapter'] > 0)
                    <span style="position:absolute;top:-.5rem;left:-.5rem;background:rgb(220,38,38);color:#fff;font-size:.7rem;font-weight:700;border-radius:999px;padding:.15rem .5rem">
                        {{ $counts['pending_chapter'] }} در انتظار
                    </span>
                @endif
            ...
            <button wire:click="selectExamLevel('book')"
                style="position:relative;text-align:right;cursor:pointer;background:rgba(234,179,8,0.06);border:1px solid rgba(234,179,8,0.3);border-right:4px solid rgb(202,138,4);border-radius:1rem;padding:1.25rem">
                @if ($isReviewer && $counts['pending_book'] > 0)
                    <span style="position:absolute;top:-.5rem;left:-.5rem;background:rgb(220,38,38);color:#fff;font-size:.7rem;font-weight:700;border-radius:999px;padding:.15rem .5rem">
                        {{ $counts['pending_book'] }} در انتظار
                    </span>
                @endif
